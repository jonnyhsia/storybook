...
public class SpannedGridLayoutManager extends RecyclerView.LayoutManager {
     ...
     * cell positions. Stores this layout info for use later on. Also records the adapterData position
    ...
    private void calculateCellPositions(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        for (int position = 0; position < itemCount; position++) {
            ...
            if (adapterPosition != RecyclerView.NO_POSITION) {
                ...
                // item removed from adapterData, retrieve its previous span info
                // as we can't get from the lookup (adapterData)
            ...
            // subsequent cells into gaps. We place the responsibility on the adapterData to provide
